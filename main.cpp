...
//                mY = event.button.y;
                down = false;
                        ...
                        if(down) {
            if(mX >= buttonLeft.x && mX <= buttonLeft.x + buttonLeft.w && mY >= buttonLeft.y && mY  <= buttonLeft.y + buttonLeft.h ) {
                    cX -= 10;
                } else if(mX >= buttonRight.x && mX <= buttonRight.x + buttonRight.w && mY >= buttonRight.y && mY  <= buttonRight.y + buttonRight.h ) {
                    cX += 10;
                } else if(mX >= buttonUp.x && mX <= buttonUp.x + buttonUp.w && mY >= buttonUp.y && mY  <= buttonUp.y + buttonUp.h ) {
                    cY -= 10;
                } else if(mX >= buttonDown.x && mX <= buttonDown.x + buttonDown.w && mY >= buttonDown.y && mY  <= buttonDown.y + buttonDown.h ) {
                    cY += 10;
                } else if(mX >= buttonClick.x && mX <= buttonClick.x + buttonClick.w && mY >= buttonClick.y && mY  <= buttonClick.y + buttonClick.h ) {
